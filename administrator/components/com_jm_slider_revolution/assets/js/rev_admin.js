		...
		**/
		...
		this.initEditSliderView = function(){
			...
			jQuery("#button_export_slider").click(function(){
				...
				var ajaxurl = root+"administrator/index.php?option=com_jm_slider_revolution&view=slider&format=slider";
				var urlAjaxExport = ajaxurl+"&action=export_slider&dummy="+useDummy+"&sliderid=" + sliderID;
		...
		var openPreviewSlideDialog = function(slideID,useParams){
			...
			jQuery("#dialog_preview").dialog({
					...
					open:function(event,ui){						
						var form1 = jQuery("#form_preview_slide");
