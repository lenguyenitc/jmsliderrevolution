	...
	if(!$slide->isStaticSlide()){
		...
		<div class="editor_buttons_wrapper  postbox unite-postbox" style="max-width:100% !important;">
			<h3 class="box-closed tp-accordion">
				<span class="postbox-arrow2">-</span><span><?php echo "Slider Main Image / Background" ?></span>
			</h3>
			<div class="toggled-content">
				<div class="inner_wrapper p10 pb0 pt0 boxsized">
					<div class="editor_buttons_wrapper_top">
						<h3 style="cursor:default !important; background:none !important;border:none;box-shadow:none !important;font-size:12px;padding:0px;margin:10px 0px 0px;"><?php echo "Background Source:"?></h3>
						...
						<label style="float:left;margin-left:5px;margin-top:2px;"  for="radio_back_image"><?php echo "Image BG"?></label>
						<!-- THE BG IMAGE CHANGED DIV -->
						<div id="tp-bgimagewpsrc" class="bgsrcchanger-div" style="display:none;float:left;margin-top:-7px;">
						<a class='button-primary revblue modal <?php if($bgType != "image") echo "button-disabled" ?>' id="button_change_image" rel="{handler: 'iframe', size: {x: 800, y: 500}}" title="<?php echo "Select image";?>"  href="index.php?option=com_media&view=images&tmpl=component&asset=com_jm_slider_revolution&fieldid=image_url&folder=revslider" style="margin-bottom:5px"><?php echo "Change Image"?></a>
						</div>
						...
						<label style="float:left;margin-left:5px;margin-top:2px;"for="radio_back_external"><?php echo "External URL"?></label>
						...
						<div id="tp-bgimageextsrc" class="bgsrcchanger-div" style="display:none;float:left;margin-top:-7px;">
							...
							<a href="javascript:void(0)" id="button_change_external" class="button-primary revblue <?php if($bgType != "external") echo "button-disabled" ?>" style="margin-bottom:5px"><?php echo "Get External"?></a>
						</div>
						...
						<label style="float:left;margin-left:5px;margin-top:2px;"for="radio_back_trans"><?php echo "Transparent"?></label>
						...
						<label style="float:left;margin-left:5px;margin-top:2px;"for="radio_back_solid"><?php echo "Solid Colored"?></label>
						...
						<!--<a href="javascript:void(0)" id="button_preview_slide" class="button-primary revbluedark" style="float:right;margin-top:-9px !important;" title="Preview Slide"><i class="revicon-search-1"></i><?php echo "Preview Slide"?></a>
-->
						...
						<div id="tp-bgimagesettings" class="bgsrcchanger-div" style="margin-top:10px;display:none">
							<div id="bg-setting-wrap">
								<h3 style="cursor:default !important; background:none !important;border:none;box-shadow:none !important;font-size:12px;padding:0px;margin:17px 0px 0px;"><?php echo "Background Settings:"?></h3>
								<label for="slide_bg_fit"><?php echo "Background Fit:"?></label>
								...
								<label for="slide_bg_repeat"><?php echo "Background Repeat:"?></label>
								...
								<label for="slide_bg_position" id="bg-position-lbl"><?php echo "Background Position:"?></label>
							...
							<div style="clear:both"></div>
							<h3 style="cursor:default !important; background:none !important;border:none;box-shadow:none !important;font-size:12px;padding:0px;margin:17px 0px 0px; float: left;"><?php echo "Ken Burns / Pan Zoom Settings:"?></h3>

							<div style="margin-top: 15px; margin-left: 10px; float: left;">
								<input type="radio" name="kenburn_effect" value="on" <?php echo ($kenburn_effect == 'on') ? 'checked="checked"' : ''; ?> /> <?php echo "On"?>&nbsp;&nbsp;<input type="radio" name="kenburn_effect" value="off" <?php echo ($kenburn_effect == 'off') ? 'checked="checked"' : ''; ?> /> <?php echo "Off"?>
							</div>
							<div class="clear"></div>
							...
							<table id="kenburn_wrapper" <?php echo ($kenburn_effect == 'off') ? 'style="display: none;"' : ''; ?>>
								...
								<tr>
									<td><?php echo "Start Position:"?></td>
									<td colspan="2" id="bg-start-position-wrapper-kb">

									</td>
									<td></td>
									<td><?php echo "Start Fit: (in %)"?></td>
	...
	<div class="editor_buttons_wrapper  postbox unite-postbox" style="max-width:100% !important;">
		<h3 class="box-closed tp-accordion">
			<span><?php if($slide->isStaticSlide()){ echo "Static Layers"; }else{ ?><?php echo "Slide"; }?></span>
		</h3>
		<div class="layer-editor-toolbar">
			...
			if($slide->isStaticSlide()){
				...
				?>
				<span class="setting_text_3"><?php echo "Show Layers from Slide:" ?></span>
			...
			<div class="inner_wrapper p10 pb0 pt0 boxsized">
				...
				<div class="editor_buttons_wrapper_bottom">
					<div style="float:left">
						<a href="javascript:void(0)" id="button_add_layer" 		 data-isstatic="<?php echo $add_static; ?>" class="button-primary revblue"><i class="revicon-layers-alt"></i><?php echo "Add Layer"?></a>
						<a class='button-primary revblue modal' id="button_add_layer_image" rel="{handler: 'iframe', size: {x: 800, y: 500}}" title="<?php echo "Select image";?>"  href="index.php?option=com_media&view=images&tmpl=component&asset=com_jm_slider_revolution&fieldid=button_add_layer_image&folder=revslider" data-isstatic="<?php echo $add_static; ?>"><i class="revicon-picture-1"></i><?php echo "Add Layer: Image"?> </a>
						<a href="javascript:void(0)" id="button_add_layer_video" data-isstatic="<?php echo $add_static; ?>" class="button-primary revblue"><i class="revicon-video"></i><?php echo "Add Layer: Video"?> </a>
						<!--a href="javascript:void(0)" id="button_add_layer_image_static" class="button-primary revblue"><i class="revicon-picture-1"></i><?php echo "Add Static Layer: Image"?> </a>
						<a href="javascript:void(0)" id="button_add_layer_video_static" class="button-primary revblue"><i class="revicon-video"></i><?php echo "Add Static Layer: Video"?> </a-->
						<a href="javascript:void(0)" id="button_duplicate_layer" class="button-primary revyellow button-disabled"><i class="revicon-picture"></i><?php echo "Duplicate Layer"?></a>
					</div>
					<div style="float:right;">
						<a href="javascript:void(0)" id="button_delete_layer"    class="button-primary  revred button-disabled"><i class="revicon-trash"></i><?php echo "Delete Layer"?></a>
			...
			<div class="edit_layers_right" style="position:relative;height:100%">
				<div class="postbox unite-postbox layer_sortbox" style="height:100%;">
					...
					<h3 class="no-accordion">
						<span><?php echo "Layers Timing & Sorting"?></span>																																				
					</h3>
					<div style="display:table; line-height:30px">
						<div style="display:table-cell; padding:10px 15px; min-width:45px;"><?php echo "z-Index"?></div>
						<div style="display:table-cell; min-width:78px">
							<div id="button_sort_visibility" class="tipsy_enabled_top" title="<?php echo 'Hide All Layers'?>"><i class="eg-icon-eye"></i><i class="eg-icon-eye-off"></i></div>
							<div id="button_sort_lock" class="tipsy_enabled_top" title="<?php echo 'Lock All Layers'?>"><i class="eg-icon-lock-open"></i><i class="eg-icon-lock"></i></div>	
							<div id="button_sort_tillend" class="tipsy_enabled_top" title="<?php echo 'Snap to Slide End / Custom End'?>"><i class="eg-icon-back-in-time"></i></div>											
						</div>
						<div style="display:table-cell;padding:10px 15px 10px 0px;width:100%"><?php echo "Timing"?>
							<div id="button_sort_timing" class="button-primary revblue" style="margin-left:15px !important" title="<?php echo 'Show / Hide Timer Settings'?>"><i class="eg-icon-equalizer"></i> <span class="onoff"> - on</span></div>
						</div>									
						<div style="display:table-cell;padding:10px 0px 10px 0px; min-width:50px;"><?php echo "Start"?></div>									
						<div style="display:table-cell;padding:10px 0px 10px 0px; min-width:54px;"><?php echo "End"?></div>																		
					</div>									
			...
			<div class="edit_layers_left">
				...
				<form name="form_layers" id="form_layers">
					...
					<div class='settings_wrapper' style="<?php echo $show_static; ?>">
						<div class="postbox unite-postbox">
							<h3 class='no-accordion tp-accordion'><span class="postbox-arrow2">-</span>
								<span><?php echo "Static Options"?> </span>
							</h3>
							<div class="toggled-content tp-closeifotheropen">
								<ul class="list_settings">
									...
									<div id="layer_static_wrapper"<?php echo ($isTemplate == "true") ? ' style="display: none;"' : ''; ?>>
										<li>
											<div id="static_start_on_wrap" class="setting_text"><?php echo 'Start on Slide'; ?></div>
										...
										<div class="clear"></div>
										<li>
											<div id="static_end_on_wrap" class="setting_text"><?php echo 'End on Slide'; ?></div>
					...
					<div class='settings_wrapper'>
						<div class="postbox unite-postbox">
							<h3 class='no-accordion tp-accordion'><span class="postbox-arrow2">-</span>
								<span><?php echo "Layer General Parameters"?> </span>
							</h3>
							<div class="toggled-content tp-closeifotheropen">
								<ul class="list_settings">
									<li id="end_layer_sap" class="attribute_title" style="margin-top:-10px;">
										<span class="setting_text_2 text-disabled" original-title=""><?php echo "Layer Content"?></span>
										<!--<hr>-->
									</li>
									<?php
									...
									?>
									<li style="clear:both">
										<span class="setting_text_2 text-disabled" original-title=""><?php echo "Align, Position & Styling"?></span>
										<!--<hr>-->
									</li>
									...
									<li id="layer_scale_title_row" style="clear:both;">
										<span class="setting_text_2 text-disabled" original-title=""><?php echo "Image Scale (dimensions in pixel)"?></span>
										<!--<hr>-->
									</li>
									<a id="reset-scale" class="revred button-primary" href="javascript:void(0);"><?php echo "Reset Size"?></a>
									<?php
									...
									<li id="layer_2d_title_row" style="clear:both;">
										<span class="setting_text_2 text-disabled" original-title=""><?php echo "Final Rotation"?></span>
										<!--<hr>-->
									</li>
									<div style="clear: both;">
										<?php
									...
									<div id="parallax_wrapper_div" style="<?php echo $show_parallax; ?>">
										<li id="parallax_title_row" style="clear:both;">
											<span class="setting_text_2 text-disabled" original-title=""><?php echo "Parallax Setting"?></span>
											<!--hr-->
										</li>
										<?php
					...
					<div class='settings_wrapper'>
						<div class="postbox unite-postbox">
							<h3 class='no-accordion tp-accordion tpa-closed'><span class="postbox-arrow2">+</span>
								<span><?php echo "Layer Animation"?> </span>
							</h3>
							<div class="toggled-content tp-closedatstart tp-closeifotheropen">
								<ul class="list_settings">
									...
									<li id="end_layer_sap" class="attribute_title" style="margin-top:-10px;">
										<span class="setting_text_2 text-disabled" original-title=""><?php echo "Preview Transition (Star end Endtime is Ignored during Demo)"?></span>
										<!--<hr>-->
									</li>
									...
									<li id="end_layer_sap" class="attribute_title" style="">
										<span class="setting_text_2 text-disabled" original-title=""><?php echo "Start Transition"?></span>
										<!--<hr>-->
									</li>
									<div class="layer-animations">
										...
										<a href="javascript:void(0)" id="add_customanimation_in" 	class="button-primary revblue"><i class="revicon-equalizer"></i><?php echo "Custom Animation"?></a>
										<div class="clear"></div>
										<?php
									...
									<!--LAYER END ANIMATION -->
									<li id="end_layer_sap" class="attribute_title" style="">
										<span class="setting_text_2 text-disabled" original-title=""><?php echo "End Transition (optional)"?></span>
										<!--<hr>-->
									</li>
									<div class="layer-animations">
									<div style="float:left;margin-right:10px;"><?php
										...
										<a href="javascript:void(0)" id="add_customanimation_out" 	class="button-primary revblue"><i class="revicon-equalizer"></i><?php echo "Custom Animation"?></a>
										<div class="clear"></div>
										<?php
									...
									<li id="loop_layer_sap" class="attribute_title" style="">
										<span class="setting_text_2 text-disabled" original-title=""><?php echo "Loop Animation"?></span>
										<!--<hr>-->
									</li>
									<?php
					...
					<div id="layeranimeditor_wrap" title="Layer Animation Editor" style="display:none;margin-bottom:0px; padding-bottom:0px;">
						...
						<div class="settings_wrapper">
							<div class="postbox unite-postbox">
								<h3 class="no-accordion tp-accordion">
									<span style="font-size:13px;padding-left:4px;"><i class="revicon-equalizer"></i><?php echo "Layer Animation Settings Panel"?></span>
									<span style="float: right;"><a href="javascript:void(0);" style="margin-top:-7px;border: none;font-weight: 400;box-shadow: none;-webkit-box-shadow: none;-moz-box-shadow: none;" id="set-random-animation" class="button-primary revgreen"><i class="eg-icon-shuffle"></i><?php echo "Randomize"?></a></span>
								</h3>
								...
								<table style="border-spacing:0px">
									...
									<tr class="css-edit-title graybasicbg" ><td colspan="6" style="padding:10px"><?php echo "Transition"?></td></tr>
									...
									<tr class="css-edit-title"><td colspan="6" style="padding:10px"><?php echo "Rotation" ?></td></tr>
									<tr>
										<td><?php echo "X:" ?></td>
										<td style="padding-bottom:15px">
								...
								<table style="border-spacing:0px">
									...
									<tr class="css-edit-title graybasicbg">
										<td colspan="4" style="padding:10px"><?php echo "Scale" ?></td>
										<td colspan="4" style="padding:10px;padding-left:20px"><?php echo "Skew" ?></td>
									</tr>
									...
									<tr class="graybasicbg">
										...
										<!-- SCALE Y -->
										<td style="width:30px;"><?php echo "Y:" ?></td>
										<td style="width:100px; padding-bottom:15px; ">
								...
								<table style="border-spacing:0px padding-bottom:10px">
									...
									<tr class="css-edit-title">
										<td colspan="2" style="padding:10px"><?php echo "Opacity"?></td>
										<td colspan="2" style="padding:10px;padding-left:20px"><?php echo "Perspective"?></td>
										<td colspan="2" style="padding:10px;padding-left:20px"><?php echo "Origin"?></td>
									</tr>
						...
						<div class="settings_wrapper">
							<div class="postbox unite-postbox">
								<h3 class="no-accordion tp-accordion">
									<span style="font-size:13px;padding-left:4px;"><i class="eg-icon-tools"></i><?php echo "Test Parameters"?></span>
									<span style="font-size: 9px;text-align: right;font-weight: 300;font-style: italic;white-space: nowrap;"><?php echo "*These Settings are only for Customizer. Settings can be set per Start and End Animation."?></span>
								</h3>
									...
									<div id="caption-inout-controll" class="caption-inout-controll">
										<i id="revshowmetheinanim" class="revicon-login reviconinaction"></i><i id="revshowmetheoutanim" class="revicon-logout"></i><?php echo "Transition Direction"?>
									</div>
					...
					<div class='settings_wrapper'>
						<div class="postbox unite-postbox">
							<h3 class='no-accordion tp-accordion tpa-closed'><span class="postbox-arrow2">+</span>
								<span><?php echo "Layer Links & Advanced Params"?> </span>
							</h3>
							<div class="toggled-content tp-closedatstart tp-closeifotheropen">

								<ul class="list_settings">
									<li class="custom attributes_title" style="margin-top:-10px;">
										<span class="setting_text_2 text-disabled" original-title=""><?php echo "Links (optional)"?></span>
										<!--<hr>-->
									</li>
									...
									<li id="" class="custom attributes_title" style="">
										<span class="setting_text_2 text-disabled" original-title=""><?php echo "Caption Sharp Corners (optional only with BG color)"?></span>
										<!--<hr>-->
									</li>
									<div class="layer-links">
										<?php
									...
									<li id="" class="custom attributes_title" style="">
										<span class="setting_text_2 text-disabled" original-title=""><?php echo "Advanced Responsive Settings"?></span>
										<!--<hr>-->
									</li>
									<div class="layer-links">
										<?php
									...
									<li id="custom_attributes" class="custom attributes_title" style="">
										<span class="setting_text_2 text-disabled" original-title=""><?php echo "Attributes (optional)"?></span>
										<!--<hr>-->
									</li>
									<?php
										$s = $settingsLayerOutput;
...
<div id="dialog_template_insert" class="dialog_template_help" title="<?php echo "Template Insertions" ?>" style="display:none;">
	<b><?php echo "Post Replace Placeholders:" ?></b>
	<table class="table_template_help">
		<tr><td><a href="javascript:UniteLayersRev.insertTemplate('meta:somemegatag')">%meta:somemegatag%</a></td><td><?php echo "Any custom meta tag" ?></td></tr>
		<tr><td><a href="javascript:UniteLayersRev.insertTemplate('title')">%title%</a></td><td><?php echo "Post Title" ?></td></tr>
		<tr><td><a href="javascript:UniteLayersRev.insertTemplate('excerpt')">%excerpt%</a></td><td><?php echo "Post Excerpt" ?></td></tr>
		<tr><td><a href="javascript:UniteLayersRev.insertTemplate('alias')">%alias%</a></td><td><?php echo "Post Alias" ?></td></tr>
		...
		<tr><td><a href="javascript:UniteLayersRev.insertTemplate('date_modified')">%date_modified%</a></td><td><?php echo "Date modified" ?></td></tr>
		<tr><td><a href="javascript:UniteLayersRev.insertTemplate('author_name')">%author_name%</a></td><td><?php echo "Author name" ?></td></tr>
		...
		<tr><td><a href="javascript:UniteLayersRev.insertTemplate('catlist')">%catlist%</a></td><td><?php echo "List of categories with links" ?></td></tr>
		<tr><td><a href="javascript:UniteLayersRev.insertTemplate('taglist')">%taglist%</a></td><td><?php echo "List of tags with links" ?></td></tr>
	</table>
	<?php $UniteEmRev = new UniteEmRev();?>
	<?php if($UniteEmRev::isEventsExists()):?>

	<br><br>

	<b><?php echo "Events Placeholders:" ?></b>
	<table class="table_template_help">
		<tr><td><a href="javascript:UniteLayersRev.insertTemplate('event_start_date')">%event_start_date%</a></td><td><?php echo "Event start date" ?></td></tr>
		<tr><td><a href="javascript:UniteLayersRev.insertTemplate('event_end_date)">'%event_end_date%</a></td><td><?php echo "Event end date" ?></td></tr>
		<tr><td><a href="javascript:UniteLayersRev.insertTemplate('event_start_time')">%event_start_time%</a></td><td><?php echo "Event start time" ?></td></tr>
		<tr><td><a href="javascript:UniteLayersRev.insertTemplate('event_end_time)">'%event_end_time%</a></td><td><?php echo "Event end time" ?></td></tr>
		<tr><td><a href="javascript:UniteLayersRev.insertTemplate('event_event_id')">%event_event_id%</a></td><td><?php echo "Event ID" ?></td></tr>
		<tr><td><a href="javascript:UniteLayersRev.insertTemplate('event_location_name')">%event_location_name%</a></td><td><?php echo "Event location name" ?></td></tr>
		<tr><td><a href="javascript:UniteLayersRev.insertTemplate('event_location_slug%')">%event_location_slug%</a></td><td><?php echo "Event location slug" ?></td></tr>
		<tr><td><a href="javascript:UniteLayersRev.insertTemplate('event_location_address)">%event_location_address%</a></td><td><?php echo "Event location address" ?></td></tr>
		<tr><td><a href="javascript:UniteLayersRev.insertTemplate('event_location_town')">%event_location_town%</a></td><td><?php echo "Event location town" ?></td></tr>
		<tr><td><a href="javascript:UniteLayersRev.insertTemplate('event_location_state')">%event_location_state%</a></td><td><?php echo "Event location state" ?></td></tr>
		<tr><td><a href="javascript:UniteLayersRev.insertTemplate('event_location_postcode')">%event_location_postcode%</a></td><td><?php echo "Event location postcode" ?></td></tr>
		<tr><td><a href="javascript:UniteLayersRev.insertTemplate('event_location_region')">%event_location_region%</a></td><td><?php echo "Event location region" ?></td></tr>
		<tr><td><a href="javascript:UniteLayersRev.insertTemplate('event_location_country')">%event_location_country%</a></td><td><?php echo "Event location country" ?></td></tr>
	</table>
