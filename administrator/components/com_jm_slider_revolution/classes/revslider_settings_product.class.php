...
class RevSliderSettingsProduct extends UniteSettingsRevProductRev{
	...
	protected function drawSliderSize($setting){
		...
		$textNormalW = "Grid Width:";
		$textNormalH = "Grid Height:";
		
		$textFullWidthW = "Grid Width:";
		$textFullWidthH = "Grid Height:";
		
		$textFullScreenW = "Grid Width:";
		$textFullScreenH = "Grid Height:";
