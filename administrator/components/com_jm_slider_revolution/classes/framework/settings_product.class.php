...
class UniteSettingsRevProductRev extends UniteSettingsOutputRev{
	...
	protected function drawImageInput($setting){
		...
		?>
			...
			<a style="width: 110px !important; float: left;" class='button-primary revblue modal btn-img-select' id="<?php echo $buttonID?>" rel="{handler: 'iframe', size: {x: 800, y: 500}}" title="<?php echo "Choose Image";?>"  href="index.php?option=com_media&view=images&tmpl=component&asset=com_jm_slider_revolution&fieldid=<?php echo $setting["id"]?>&folder=revslider"><?php echo "Choose Image";?></a>
			<input type="button" class="btn-img-remove button-primary revred" style="width: 110px !important;" id="<?php echo $buttonRemoveID; ?>" value="<?php echo 'Remove'; ?>" />
			<div class="clear"></div>
		<?php
	}
