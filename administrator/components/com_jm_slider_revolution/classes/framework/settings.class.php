...
class UniteSettingsRev{
	...
	static $path_settings = null;
	static $url_plugin = null;
	...
	public function __construct(){
		self::$path_settings = JPATH_COMPONENT_ADMINISTRATOR.'/settings';
	...
	public function setSettingsStateByControls(){
		foreach($this->arrControls as $control_name => $arrControlled){
			...
			if(!isset($this->arrIndex[$control_name])&& ($control_name !='source_type')) throw new Exception("There is not sutch control setting: '$control_name'");
