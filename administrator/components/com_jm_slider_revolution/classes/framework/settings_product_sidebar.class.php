...
class UniteSettingsProductSidebarRev extends UniteSettingsOutputRev{
	...
	public function drawShadowTypes($current){
		...
		<li  class="shadowTypes shadowType-0"<?php echo ($current == 0) ? ' style="display: none;"' : ''; ?>>
			<img class="shadowTypes shadowType-1" src="<?php echo UniteBaseClassRev::$url_plugin; ?>assets/images/shadow1.png"<?php echo ($current == 1) ? '' : ' style="display: none;"'; ?> width="271" />
			<img class="shadowTypes shadowType-2" src="<?php echo UniteBaseClassRev::$url_plugin; ?>assets/images/shadow2.png"<?php echo ($current == 2) ? '' : ' style="display: none;"'; ?> width="271" />
			<img class="shadowTypes shadowType-3" src="<?php echo UniteBaseClassRev::$url_plugin; ?>assets/images/shadow3.png"<?php echo ($current == 3) ? '' : ' style="display: none;"'; ?> width="271" />   
		</li>
		<script type="text/javascript">
			/**
			 * set shadow type
	...
	public function drawCssEditor(){
		?>
		<div id="css_editor_wrap" title="<?php echo "Style Editor" ?>" style="display:none;">
			...
			<div id="css-editor-accordion">
				<h3><?php echo "Simple Editor:"?></h3>
				<div class="css_editor_novice_wrap">
					<table style="border-spacing:0px">
						<tr class="css-edit-enable"><td colspan="4"><input class="css_edit_novice" type="checkbox" name="css_allow" /> <?php echo "enable " ?> <span id="css_editor_allow"></span></td></tr>
						...
						<tr>
							...
							<td><input type="checkbox" name="css_font-style" class="css_edit_novice" /> <?php echo "italic" ?></td>
				...
				<h3 class="notopradius" style="margin-top:20px"><?php echo "Advanced Editor:"?></h3>
				<div>
		...
		<div id="dialog-change-css" title="<?php echo "Save Styles" ?>" style="display:none;">
			<p><span class="ui-icon ui-icon-alert" style="float: left; margin: 0 7px 50px 0;"></span><?php
			echo 'Overwrite the current selected class ';
			echo '"<span id="current-class-handle"></span>"';
			echo ' or save the styles as a new class?'?></p>
		</div>
		
		<div id="dialog-change-css-save-as" title="<?php echo "Save As" ?>" style="display:none;">
			<p>
				<?php echo 'Save as class:'?><br />
	...
	public function drawGlobalCssEditor(){
		?>
		<div id="css_static_editor_wrap" title="<?php echo "Global Style Editor" ?>" style="display:none;">
			<div id="css-static-accordion">
				<h3><?php echo "Dynamic Styles (Not Editable):"?></h3>
				<div class="css_editor_novice_wrap">
					<textarea id="textarea_show_dynamic_styles" rows="20" cols="81"></textarea>
				</div>
				<h3 class="notopradius" style="margin-top:20px"><?php echo "Static Styles:"?></h3>
				<div>
