...
<form action="<?php echo JRoute::_('index.php?option=com_jm_deluxe_layer_slideshow&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="category-form" class="form-validate">
